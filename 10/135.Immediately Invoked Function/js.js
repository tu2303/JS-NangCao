...
people can choose, and an array with the number of replies
...
object. The method does 2 things:
 ...
 should look like this:
          What is your favouritr programming language? 
          0: JavaScript 
          1: Python
          2: Rust
          3: C++
  ...
  the value AT POSITTION 3 of the array by 1. Make 
  Sure to check if the input is a number and if the input is a 
...
should be the default option. If type is 'string', display a string like "poll results are 13, 2, 4, 1".
...
2 arrays in the test data. Use both the 'array' and the 'string' option. Do NOT put the arrays in the 
poll object! so what shoud the this keyword look like 
in this situation ?

BONUS TEST DATA: [5, 2, 3]
BONUS TEST DATA2: [1, 5, 3, 9, 6, 1]
